...
const groups = [
  {
    ...
    items: [
      [
        "AI Card generation",
        "From design presets, or from a reference card you upload",
      ],
      [
        "Upload a card",
        "If you already have an invitation card you like to use",
      ],
      [
        "Design presets",
        "Classic elegant, modern minimalist, rustic botanical, vintage royal, moody avant-garde",
      ],
      [
        "Paper and finish",
        "Smooth matte, deckled watercolour, heavy linen, frosted vellum, pearl shimmer",
      ],
      [
        "Metallic accents",
        "Gold foil, silver filigree, rose gold leaf, holographic edge",
      ],
      [
        "Edges and monogram",
        "Sharp, torn, gilded, scalloped or floral bleed; crest, serif initials, floral wreath or deco shield",
      ],
      [
        "Header image",
        "A matching illustration generated for the top of the RSVP page",
      ],
      [
        "Attire styling",
  ...
  },
  {
    ...
    items: [
      ...
      [
        "Accommodation",
        "Whether a guest needs a room, and the address they're staying at",
      ],
      ["Search and filters", "Find anyone by name, ceremony or reply status"],
      [
        "Edit any time",
        "Add, change or remove a guest after invitations have gone out",
      ],
    ],
  },
  {
    ...
    items: [
      [
        ...
        "Mehendi, Haldi, Sangeet, Reception, or whatever you call yours",
      ],
      ...
      [
        "Live stats per ceremony",
        "Attending, maybe, declined, pending and a completion percentage",
      ],
    ],
  },
  {
    ...
    items: [
      ...
      [
        "Meal preference",
        "Vegetarian, non-vegetarian, vegan, eggetarian, lactose free, gluten free or other",
      ],
      ...
      [
        "Changes of mind",
        "Guests reopen their link and change the answer until the deadline",
      ],
      [
        "No account needed",
        "Guests never sign up, sign in, or install anything",
      ],
    ],
  },
  {
    ...
    items: [
      ...
      [
        "Headline counts",
        "Invited, attending, awaiting reply, needing accommodation",
      ],
      [
        "Per-ceremony progress",
        "The confirmed, maybe, declined and pending split for each",
      ],
      ["Meal breakdown", "Dietary preferences across everyone attending"],
      [
        "Guests by side",
        "How the confirmed list splits between the two families",
      ],
      [
        "Replies over time",
        "Daily response counts, so you can see if a reminder landed",
      ],
      [
        "Recent replies",
        "The last answers as they come in, with who said what",
      ],
    ],
  },
  {
